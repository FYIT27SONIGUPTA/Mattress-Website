...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <img class="image" style="height:220px" src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="">
         <div class="name" style="height:50px"><?php echo $fetch_products['name']; ?></div>
         <div class="details" style="height:50px"><?php echo $fetch_products['details']; ?></div>
